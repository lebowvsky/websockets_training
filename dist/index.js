...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var schema, server, app, PORT;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.createConnection()];
            case 1:
                _a.sent();
                return [4 /*yield*/, type_graphql_1.buildSchema({ resolvers: [AppUserResolver_1.default] })];
            case 2:
                schema = _a.sent();
                ...
                app.listen({ port: PORT }, function () {
                    return console.log("server is ready at http://localhost:" + PORT + server.graphqlPath);
                });
                return [2 /*return*/];
        }
    });
